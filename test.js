...
exports.run = (client, message, args) => {
	...
	request('https://rust-servers.net/api/?object=servers&element=voters&key=fMfruWLJibpYrcIpGfg1zQ2koShJ5hdfVOH&month=current&format=json&limit=1', { json: true }, (err, res, body) => {
        if (err) {
            return console.log(err);
        }
		//console.log(body);

        let topVoter = body.nickname;
